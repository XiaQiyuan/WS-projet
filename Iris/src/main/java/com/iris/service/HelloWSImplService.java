 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://service.iris.com/", wsdlLocation = "http://127.0.0.1:8989/iris/hellows?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSIMPLSERVICE_QNAME = new QName("http://service.iris.com/", "HelloWSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8989/iris/hellows?wsdl");
    ...
    public HelloWSImpl getHelloWSImplPort() {
        return super.getPort(new QName("http://service.iris.com/", "HelloWSImplPort"), HelloWSImpl.class);
    }
    ...
    public HelloWSImpl getHelloWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.iris.com/", "HelloWSImplPort"), HelloWSImpl.class, features);
    }
