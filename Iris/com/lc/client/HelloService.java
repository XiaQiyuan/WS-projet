 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://ws.sherlon.com/", wsdlLocation = "http://localhost:8080/com.lc.webservice.Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://ws.sherlon.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/com.lc.webservice.Hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://ws.sherlon.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.sherlon.com/", "HelloPort"), Hello.class, features);
    }
